...
export const SMART_PARAPHRASE_BOX_PROPS: PropRow[] = [
  ...
  { name: 'maxTokens', type: 'number', default: '256', description: 'Max tokens for the rewrite call.' },
  ...
  { name: 'onRewriteAccept', type: '(rewrite: string) => void', description: 'Called when a rewrite is accepted, with the rewritten text.' },
